  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1B2025] from-20% to-[#08090B] text-white pb-[200px]">
      <div className="flex flex-col items-center w-full ">
        <div className="w-full md:w-10/12 bg-[#484F8E]/70 md:bg-[#484F8E] -mt-32 md:mt-0 h-24 md:h-48 rounded-full md:rounded-none md:rounded-b-[50px] flex items-center justify-evenly">
          <div className="flex flex-col items-center justify-center mt-4 md:mt-0 w-1/3 text-center">
            <h2 className="flex text-lg md:text-2xl lg:text-3xl xl:text-4xl">
          ...
          <div className="flex flex-col items-center justify-center mt-4 md:mt-0 w-1/3 text-center">
            <h2 className="text-lg md:text-2xl lg:text-3xl xl:text-4xl flex">
              Monthly Users
            </h2>
            <span className="text-lg md:text-5xl lg:text-6xl xl:text-7xl">
              1,300+
          ...
          <div className="flex flex-col items-center justify-center mt-4 md:mt-0 w-1/3 text-center">
            <h2 className="text-lg md:text-2xl lg:text-3xl xl:text-4xl">
              Install Time
            </h2>
            <span className="text-lg md:text-5xl lg:text-6xl xl:text-7xl">
              80
        ...
        <p className="mt-[67px] md:text-[30px] px-8 md:px-32 text-center">
